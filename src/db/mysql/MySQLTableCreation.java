	...
	public static void main(String[] args) {
		try {
			...
			try {
				...
				Class.forName("com.mysql.jdbc.Driver").getConstructor().newInstance();  //reflection  After it the driver register will finish
				conn = DriverManager.getConnection(MySQLDBUtil.URL); // after registered we get connection
